...
function displayQuestionsInPopup(questions, completionUrl) {
  ...
  function displayQuestion() {
    ...
    questionElement.innerHTML = `
            <h2 class='question-heading'>Q${currentQuestionIndex + 1}: ${
    ...
    options.forEach((option) => {
      option.addEventListener("click", () => {
        ...
        if (
          ...
          currentQuestion.subQuestions[selectedIndex]
        ) {
  ...
  function displaySubQuestions(subQuestions) {
    ...
    function displaySubQuestion() {
      ...
      subQuestionElement.innerHTML = `
                <h2 class='question-heading'>Q${currentSubQuestionIndex + 1}: ${
...
const maleQuestions = [
  ...
  },
  {
    ...
    options: ["Skipping", "Walking", "Going to the gym", "I don't do exercise"],
  },
];
...
const femaleQuestions = [
  {
    ...
    subQuestions: [
      ...
      [
        ...
        {
          question:
            "Do you experience shortness of breath after walking a distance?",
      ...
      [
        {
          question: "You Are A Student of Futo",
          options: [
            "You've tried your best but e no gree enter",
            "You've given up on futo",
            "You have are not coming back next semseter",
          ],
        },
      ],
    ],
